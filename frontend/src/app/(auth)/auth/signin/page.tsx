      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full rounded-md border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-white shadow-sm placeholder:text-zinc-500 focus:ring-2 focus:ring-violet-500 focus:outline-none aria-invalid:border-red-500"
        ...
        <button
          ...
          className="w-full rounded-md bg-violet-500 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-violet-600 disabled:cursor-not-allowed disabled:opacity-50"
        >
